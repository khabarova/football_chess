...
def menu():
    ...
    quit_btn = Button(150, 70)
    res_btn = Button(150, 70)
    show = True
    ...
    while show:
        ...
        quit_btn.draw(350, 300, 'Quit', quit)
        res_btn.draw(150, 300, 'Result', show_res)
...
def show_res():
    ...
    screen.fill('black')
    pygame.display.set_caption("Result of last game")
    screen.blit(menu_back, (0, 0))
    document = open('highscore1.txt', encoding='utf8')
    document1 = document.readlines()
    document2 = open('highscore2.txt', encoding='utf8')
    document2 = document2.readlines()
    document3 = open('highscore3.txt', encoding='utf8')
    document3 = document3.readlines()
    return_button1 = pygame.draw.rect(screen, (57, 255, 20), (0, 400, 150, 100))
    y = 75
    y1 = 50
    for el in document1:
        el = el.replace('\n', '')
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if 150 >= pygame.mouse.get_pos()[0] >= 0 and 500 >= pygame.mouse.get_pos()[1] >= 400:
...
def rules():
    ...
    return_button = pygame.draw.rect(screen, (57, 255, 20), (0, 400, 150, 100))
    screen.blit(menu_back, (0, 0))
